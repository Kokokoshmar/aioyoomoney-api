...
from aioyoomoney.data_classes.digital import DigitalProduct, DigitalBonus, DigitalGood
from aioyoomoney.exceptions import IllegalParamOperationId, TechnicalError
